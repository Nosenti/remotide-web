  ...
  return (
    <div className="my-4 mx-4">
      ...
      <div className="team-members flex flex-wrap justify-center md:justify-between">
        <div className="member-1 w-full md:w-[45%] lg:w-[30%] h-[70vh] my-4 relative group hover:bg-transparent rounded-lg overflow-hidden border border-transparent hover:border-blue-500">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center z-20">
            <div className="hidden group-hover:block text-white text-center mb-10 text-md p-1">
